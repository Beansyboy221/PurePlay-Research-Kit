...
class AutoencoderBase(base.BaseModel, abc.ABC):
    training_type = base.TrainStrategy.UNSUPERVISED
    ...
    def _common_step(self, batch, batch_idx, stage: str) -> torch.Tensor:
        ...
        self.log(name=f"{stage}_loss", value=loss, on_step=False, on_epoch=True)
        return loss
    ...
    def test_step(self, batch, batch_idx) -> None:
        ...
        self.test_step_outputs.append(
            {"Batch_Index": batch_idx, "MSE_Loss": loss.detach().item()}
        )
