...
from preprocessing import params as data_params, scalers
from . import params
...
class TrainStrategy(enum.StrEnum):
    ...
    """Training given positive and negative cases."""

    UNSUPERVISED = enum.auto()
    """Training given only either positive or negative cases."""


class BaseModel(
    lightning.LightningModule, abc.ABC, init_mixins.OnInitConcreteSubclassMixin
):
